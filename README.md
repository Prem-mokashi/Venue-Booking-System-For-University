...
- **Interactive Calendar**: View booking availability with color-coded calendar
...
- **Venue Management**: Add, edit, or remove venues
...
- **Conflict Prevention**: System prevents double bookings
...
### Enable GD Extension (for PDF generation)
...
3. Use App Password in `email_helper.php`
...
**1. "Network error" during VTU ID verification**
...
**3. Calendar not showing bookings**
...
3. Fill in details (name, location, capacity, etc.)
4. Upload venue image
5. Save
...
- **Email**: venues@vtu.ac.in
- **Phone**: +91-831-2498000
- **Location**: VTU Belagavi, Karnataka 590018

## 🙏 Acknowledgments

- **VTU Belagavi** for providing the requirements
...
**Developed for**: Visvesvaraya Technological University, Belagavi
